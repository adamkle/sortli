...
const NavigationIcon: React.FC<NavigationIconProps> = ({ name, size = 24, color = '#1E1B4B', style }) => {
  ...
  switch (name) {
    ...
    case 'refresh-outline':
      ...
      break;
    case 'logo-google':
      path = 'M12.24 10.285V13.4h6.887c-.275 1.565-1.88 4.604-6.887 4.604-4.33 0-7.859-3.578-7.859-8s3.53-8 7.859-8c2.46 0 4.105 1.025 5.047 1.926l2.427-2.334C17.955 2.192 15.34 1 12.24 1 6.033 1 12.24s5.033 11.24 11.24 11.24c6.478 0 10.793-4.537 10.793-10.988 0-.746-.08-1.32-.176-1.887H12.24z';
      break;
    case 'logo-whatsapp':
